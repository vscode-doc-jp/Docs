...
<div class="comment"><p><a href="#CodeActionProvider.provideCodeActions">code action</a> が実行されているコンテキストに関する追加の診断情報を含みます</p>
</div>
...
<div class="comment"><p>code action interface は拡張機能と <a href="https://code.visualstudio.com/docs/editor/editingevolved#_code-action">light bulb</a> 機能の間のコントラクトを定義します</p>
<p>code action はシステムに <a href="#commands.getCommands">known</a> されている任意のコマンドです</p>
</div>
...
<div class="comment"><p>指定されたドキュメントと範囲にコマンドを提供します</p>
</div>
<div class="signature">
<table class="table table-bordered">
<tr><th>Parameter</th><th>Description</th></tr>
...
<div class="comment"><p>情報、警告、エラーメッセージとともに表示するアクションを示します</p>
<ul>
<li><em>see</em> - <a href="#window.showInformationMessage">showInformationMessage</a></li>
</ul>
<ul>
...
<div class="comment"><p>この項目が既定の &#39;Close&#39; アクションを置き換えるものを示します</p>
</div>
</div>
...
<div class="comment"><p>&#39;Retry&#39;, &#39;Open Log&#39; といった短いタイトル</p>
</div>
</div>
...
<div class="comment"><p>メッセージの動作を構成するオプション</p>
<ul>
<li><em>see</em> - <a href="#window.showInformationMessage">showInformationMessage</a></li>
</ul>
<ul>
...
<div class="comment"><p>このメッセージがモーダルかどうかを示します</p>
</div>
</div>
...
<div class="comment"><p>プロバイダーの結果は <a href="#HoverProvider"><code>HoverProvider</code></a> のようなプロバイダーが返す値を表します。</p>
<p>このとき <code>Hover</code> のような実際の結果型 <code>T</code>、またはその型 <code>T</code> に解決される thenable です。
また <code>null</code> と <code>undefined</code> を返すことができます。これは直接的にか thenable で返すことができます。</p>
<p>次のスニペットはすべて <a href="#HoverProvider"><code>HoverProvider</code></a> の有効な実装です:</p>
...
<table class="table table-bordered">
<tr><th>Parameter</th><th>Description</th></tr>
<tr><td><a name="line"></a><span class="ts" id=52 data-target="#details-52" data-toggle="collapse"><span class="ident">line</span><span>: </span><a class="type-instrinct">number</a></span></td><td><div class="comment"><p>A line number [0, lineCount]</p>
</div></td></tr>
<tr><th>Returns</th><th>Description</th></tr>
